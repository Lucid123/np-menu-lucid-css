...
Citizen.CreateThread(function()
    ...
    while true do
        Citizen.Wait(0)
        if IsControlJustReleased(1, keybindControls[keyBind]) and GetLastInputMethod(2) and showMenu then
            showMenu = false
            SetNuiFocus(false, false)
        end
        if IsControlJustReleased(1, keybindControls[keyBind]) and GetLastInputMethod(2) then
            showMenu = true
            local enabledMenus = {}
            ...
            Citizen.Wait(100)
            while IsControlJustReleased(1, keybindControls[keyBind]) and GetLastInputMethod(2) do Citizen.Wait(100) end
        end
    end
end)
